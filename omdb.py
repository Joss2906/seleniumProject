...
extractor = WebDataExtractor("config_omdb.json")
...
# button = driver.find_element(By.XPATH, "//a[@href='#parameters']")
# button.click()
...
# table = driver.find_element(By.XPATH, "//div[@id='parameters']/div[2]/div/div/table")
# data = []
...
# with open("JsonExport/omdbapi_data.json", "w") as file:
...
# df.to_excel("ExcelExport/omdbapi_data.xlsx", index=False)
